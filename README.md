...
│  Subscription                                                       │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │  📦 rg-handson-dev-japaneast                                  │  │
│  │  tags: env=dev, managedBy=bicep, repository=azure-bicep-speckit│  │
│  │                                                               │  │
│  │  ┌─────────────┐     ┌──────────────────────────────┐        │  │
│  │  │ 🛡️ NSG       │────▶│ 🌐 VNet 10.0.0.0/16         │        │  │
│  │  │ DenyAll      │     │  ├─ snet-default 10.0.1.0/24 │        │  │
│  │  │ Inbound      │     │  └─ snet-app     10.0.2.0/24 │        │  │
│  │  └─────────────┘     └──────────┬───────────┬────────┘        │  │
│  │                                  │           │                 │  │
│  │                          ┌───────▼──┐  ┌────▼─────┐           │  │
│  │                          │🔒 PE Blob │  │🔒 PE Vault│           │  │
